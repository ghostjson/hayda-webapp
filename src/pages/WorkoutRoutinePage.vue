                ...
                <div class="col-md-6">
                    <form @submit="submitWorkout">
                        <div class="form-group">
                            ...
                            <input type="number" v-model="workout.meta.workouts" required class="form-control" id="workouts">
                        </div>
                        <div class="form-group">
                            <label for="minutes">Minutes/Workout</label>
                            <input type="number" v-model="workout.meta.minutes" required class="form-control" id="minutes">
                        </div>
                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h3>Workout Routines <button @click="reset" class="btn btn-sm badge-light">Reset</button> </h3>
                        </div>
                        <div class="card-body">
                            <table>
                                <tr>
