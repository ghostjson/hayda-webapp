            ...
            <div class="row">
                        ...
                        <div class="post-item">
                            <div class="post-item-wrap">
                                <div class="post-image">
                                    <a href="#">
                                        <img alt="" :src="nutrition.image">
                                    </a>
                                </div>
                                <div class="post-item-description">
                                    <h2>{{ nutrition.title }}</h2>
                                    <div class="post-meta">
                                        <span class="post-meta-date"><i class="fa fa-calendar-o"></i>{{ nutrition.created_at }}</span>
                                        <span class="post-meta-category"><a href=""><i class="fa fa-tag"></i>{{ nutrition.category }}</a></span>
                                        <div class="post-meta-share">
                                            ...
                                            <a
                                                    :href="`mailto:?subject=${nutrition.title}&amp;body=Check out this site ${getLink()}.`"
                ...
                <div class="sidebar sticky-sidebar col-lg-3">
                    ...
                    <div class="widget  widget-tags">
                        <h4 class="widget-title">Categroy</h4>
                        <div class="tags">
                            <a href="#">Design</a>
                            <a href="#">Portfolio</a>
                            <a href="#">Digital</a>
    ...
    export default{
        ...
        methods: {
            async fetchNutrition(){
                ...
                let response = await Api.get('/goals/nutrition/'+id)
